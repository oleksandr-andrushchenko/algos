...
# We check whether the ant is on the boundary only after it has moved |nums[i]| units. In other words, if the ant crosses
# the boundary during its movement, it does not count.
